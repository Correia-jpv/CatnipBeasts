...
// stylers:[{color:"#283d6a"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#3a4762"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#0e1626"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#4e6d70"}]}]},d={addressNoResults:StyleHatch.Strings.addressNoResults,addressQueryLimit:StyleHatch.Strings.addressQueryLimit,addressError:StyleHatch.Strings.addressError,authError:StyleHatch.Strings.authError},u={section:'[data-section-type="maps"]',map:"[data-map]",mapOverlay:"[data-map-overlay]"},p={mapError:"map-selection--load-error",errorMsg:"map-section__errors errors text-center"};return window.gm_authFailure=function(){return Shopify.designMode?(e(u.section).addClass(p.mapError),e(u.map).remove(),void e(u.mapOverlay).after('<div class="'+p.errorMsg+'">'+StyleHatch.Strings.authError+"</div>")):void log("Google Maps authentication error",window.google,n)},t.prototype=e.extend({},t.prototype,{createMap:function(){var e=this.$map,t=e.data("map-style");return a(e).then(function(o){var a={zoom:r.zoom,center:o[0].geometry.location,draggable:!1,clickableIcons:!1,scrollwheel:!1,disableDoubleClickZoom:!0,disableDefaultUI:!0,styles:c[t]},n=this.map=new google.maps.Map(e[0],a),i=this.center=n.getCenter();new google.maps.Marker({map:n,position:n.getCenter()});google.maps.event.addDomListener(window,"resize",slate.utils.debounce(function(){google.maps.event.trigger(n,"resize"),n.setCenter(i),e.removeAttr("style")},250))}.bind(this)).fail(function(){var t;switch(status){case"ZERO_RESULTS":t=d.addressNoResults;break;case"OVER_QUERY_LIMIT":t=d.addresQueryLimit;break;case"REQUEST_DENIED":t=d.authError;break;default:t=d.addressError}Shopify.designMode&&e.parent().addClass(p.mapError).append('<div class="'+p.errorMsg+'">'+t+"</div>")})},onUnload:function(){0!==this.$map.length&&google.maps.event.clearListeners(this.map,"resize")}}),t}(),StyleHatch.PageSection=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id");StyleHatch.Page.init(o)}return t}(),StyleHatch.Page=function(){function e(e){e.fitVids()}function t(e){}return{init:e,unload:t}}(),StyleHatch.FeaturedCollectionSection=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id");o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}return t}(),StyleHatch.FeaturedCollectionSection.prototype=e.extend({},StyleHatch.FeaturedCollectionSection.prototype,{onUnload:function(t){var o=e("#section-"+t.detail.sectionId);o.attr("data-section-id");o.destroyProductBox()}}),StyleHatch.SimpleCollectionSection=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id");o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}return t}(),StyleHatch.SimpleCollectionSection.prototype=e.extend({},StyleHatch.SimpleCollectionSection.prototype,{onUnload:function(t){var o=e("#section-"+t.detail.sectionId);o.attr("data-section-id");o.destroyProductBox()}}),StyleHatch.instagrams={},StyleHatch.InstagramSection=function(){function t(t){var o=this.$container=e(t),a=o.attr("data-section-id"),r=this.instagram="#Instagram-"+a;if(e("html").hasClass("lt-ie9"))return!1;var n=o.find(".instagram-container"),i=o.find("header a.button, footer a.button"),s=o.data("image-count"),l=o.data("instagram-access-token"),c="https://api.instagram.com/v1/users/self/media/recent/?access_token="+l+"&count=20",d=432e5,u=StyleHatch.Strings.instagramAddToken,p=StyleHatch.Strings.instagramInvalidToken,h=StyleHatch.Strings.instagramRateLimitToken,f=function(){l?e.ajax({url:c,dataType:"jsonp",timeout:5e3,success:function(e){switch(e.meta.code){case 400:Shopify.designMode&&(n.attr("data-helper-text",p),storeWithExpiration.set(l,e,d),o.show());break;case 429:Shopify.designMode&&(n.attr("data-helper-text",h),o.show());break;default:y(e),storeWithExpiration.set(l,e,d)}}}):Shopify.designMode&&(n.attr("data-helper-text",u),o.show())},y=function(t){if(t.data){if(t.data.length<s){var a=t.data.length,r=s,l=r-(r-a);s=t.data.length,o.find(".box").each(function(t){t>=l&&e(this).hide()})}for(var c=0;c<s;c++){var d=t.data[c].images,u=d.thumbnail.url,p=d.thumbnail.width,h=d.low_resolution.url,f=d.low_resolution.width,y=d.standard_resolution.url,m=d.standard_resolution.width,g=t.data[c].link,v=t.data[c].likes.count,b=t.data[c].comments.count,S="";t.data[c].caption&&(S=t.data[c].caption.text);var w=o.find(".box-"+c),T=w.find("figure > a"),C=w.find("figure > a, li > a"),x=w.find("figcaption > p"),H=w.find("a.likes span.label"),$=w.find("a.comments span.label");T.html('<div class="card__image lazyload">');var k=T.find(".card__image");k.attr("data-sizes","auto"),k.attr("data-bgset",u+" "+p+"w, "+h+" "+f+"w, "+y+" "+m+"w"),C.attr("href",g),x.html(S),H.text(v),$.text(b)}var _="https://www.instagram.com/"+t.data[0].user.username;i.attr("href",_),i.attr("target","_blank"),o.show(),n.addClass("loaded")}};if(storeWithExpiration.get(l)&&!Shopify.designMode){var m=storeWithExpiration.get(l);y(m)}else f();StyleHatch.instagrams[r]=this}return t}(),StyleHatch.InstagramSection.prototype=e.extend({},StyleHatch.InstagramSection.prototype,{onUnload:function(){delete StyleHatch.instagrams[this.instagram]}}),StyleHatch.GenericSection=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id");StyleHatch.cacheSelectors()}return t}(),StyleHatch.Product=function(){function t(t){var o=this.$container=e(t),a=o.attr("data-section-id");if(this.settings={enableHistoryState:o.data("enable-history-state")||!1,imageSize:"394x",imageZoomSize:null,namespace:".slideshow-"+a,sectionId:a,zoomEnabled:!1,lightboxEnabled:!1,productImageLightboxData:[]},this.selectors={addToCart:"#AddToCart-"+a,addToCartText:"#AddToCartText-"+a,comparePrice:"#ComparePrice-"+a,originalPrice:"#ProductPrice-"+a,SKU:".variant-sku",originalSelectorId:"#ProductSelect-"+a,productFeaturedImage:"#FeaturedImage-"+a,productImageWrap:".featured-container-"+a,productPrices:".product-single__price-"+a,productThumbImages:".product-single__thumbnail--"+a,productPhoto:"#ProductPhoto-"+a,productImage:"#ProductImage-"+a,productThumbs:"#ProductThumbs-"+a,quantityWrap:".quantity-"+a,quantity:".quantity-select-"+a,cartError:".cart-error-"+a,singleOptionSelector:".single-option-selector-"+a,cartButtons:"#CartButtons-"+a,paymentButtonContainer:"#PaymentButtonContainer-"+a},e("#ProductJson-"+a).html()){this.productSingleObject=JSON.parse(document.getElementById("ProductJson-"+a).innerHTML),this.settings.zoomEnabled=e(this.selectors.productImageWrap).hasClass("featured-zoom"),this.settings.lightboxEnabled=e(this.selectors.productImageWrap).data("lightbox"),o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init(),this._initVariants(),this._initQuanitySelect(),this._initImageSwitch();var r=this;setTimeout(function(){theme.Images.preload(r.productSingleObject.images,r.settings.imageSize)},3e3)}}function o(e){e.easyZoom()}function a(e){var t=e.easyZoom().data("easyZoom");t.teardown()}return t.prototype=e.extend({},t.prototype,{_initVariants:function(){var e={$container:this.$container,enableHistoryState:this.$container.data("enable-history-state")||!1,singleOptionSelector:this.selectors.singleOptionSelector,originalSelectorId:this.selectors.originalSelectorId,product:this.productSingleObject};this.variants=new slate.Variants(e),this.$container.on("variantChange"+this.settings.namespace,this._updateAddToCart.bind(this)),this.$container.on("variantImageChange"+this.settings.namespace,this._updateImages.bind(this)),this.$container.on("variantPriceChange"+this.settings.namespace,this._updatePrice.bind(this)),this.$container.on("variantSKUChange"+this.settings.namespace,this._updateSKU.bind(this))},_initQuanitySelect:function(){var t=e(this.selectors.quantity);t.each(function(){var t=e(this),o=t.find(".adjust-minus"),a=t.find(".adjust-plus"),r=t.find("input.quantity"),n=r.val();o.on("click",function(e){n=r.val(),n>1&&(n--,r.val(n)),e.preventDefault()}),a.on("click",function(e){n=r.val(),n++,r.val(n),e.preventDefault()})})},_initImageSwitch:function(){if(!Modernizr.touchevents&&this.settings.zoomEnabled&&o(e(this.selectors.productImageWrap)),this.settings.lightboxEnabled){var t=this.productSingleObject.images;StyleHatch.productImageLightboxData=this.settings.productImageLightboxData,StyleHatch.$productPhoto=e(this.selectors.productPhoto),e(window).on("resize",function(){var o=slate.utils.defaultTo(window.devicePixelRatio,1),a=e(window).width(),r=Math.floor(o*a);StyleHatch.productImageLightboxData=[];for(var n=0;n<t.length;n++){var i=t[n],s=theme.Images.getSizedImageUrl(i,r+"x"),l={src:s};StyleHatch.productImageLightboxData.push(l)}}).trigger("resize");var a=e(this.selectors.productImageWrap);e(this.selectors.productImageWrap).find("a").magnificPopup({type:"image",mainClass:"mfp-with-zoom",items:StyleHatch.productImageLightboxData,gallery:{enabled:!0},callbacks:{beforeOpen:function(e){var t=parseInt(a.find("img").attr("data-position"));this.goTo(t)}}})}if(e(this.selectors.productThumbImages).length){var r=this;e(this.selectors.productThumbImages).on("click",function(t){t.preventDefault();var o=e(this);o.find("img").data("img"),o.find("img").data("highres");r._updateResponsiveImage(o)})}},_updateResponsiveImage:function(t){var r=t,n=r.find("img"),i=e(this.selectors.productImage),s=i.closest(".card__image-container"),l=i.closest(".featured-container"),c=i.closest(".productimage-limit");i.attr({src:n.data("default"),alt:n.attr("alt"),srcset:"","data-src":n.data("src-pattern"),"data-aspectratio":n.data("aspectratio"),"data-position":n.data("position"),"data-max-width":n.data("max-width"),"data-widths":"["+n.data("widths")+"]","data-id":i.data("id"),"data-sizes":i.data("sizes")}),c.css({"max-width":n.data("max-width")+"px"}),this.settings.zoomEnabled&&a(l),s.attr("href",r.attr("href")),!Modernizr.touchevents&&this.settings.zoomEnabled&&(s.data("zoom",r.attr("href")),o(l));var d="active";e(this.selectors.productThumbImages).removeClass(d),r.addClass(d)},_updateAddToCart:function(t){var o=t.variant;o?(e(this.selectors.cartError).hide(),e(this.selectors.productPrices).removeClass("visibility-hidden").attr("aria-hidden","true"),o.available?(e(this.selectors.addToCart).removeClass("disabled").prop("disabled",!1),e(this.selectors.addToCartText).text(StyleHatch.Strings.addToCart),e(this.selectors.quantityWrap).show(),e(this.selectors.cartButtons).addClass("cart-buttons__enabled")):(e(this.selectors.addToCart).addClass("disabled").prop("disabled",!0),e(this.selectors.addToCartText).text(StyleHatch.Strings.soldOut),e(this.selectors.quantityWrap).hide(),e(this.selectors.cartButtons).removeClass("cart-buttons__enabled"))):(e(this.selectors.addToCart).addClass("disabled").prop("disabled",!0),e(this.selectors.addToCartText).text(StyleHatch.Strings.soldOut),e(this.selectors.productPrices).addClass("visibility-hidden").attr("aria-hidden","false"),e(this.selectors.quantityWrap).hide(),e(this.selectors.cartButtons).removeClass("cart-buttons__enabled"))},_updateImages:function(t){var o,a=t.variant;theme.Images.getSizedImageUrl(a.featured_image.src,this.settings.imageSize);this.settings.zoomEnabled&&(o=theme.Images.getSizedImageUrl(a.featured_image.src,this.settings.imageZoomSize));var r=e(this.selectors.productThumbImages+'[data-image-id="'+a.featured_image.id+'"]');this._updateResponsiveImage(r)},_updatePrice:function(t){var o=t.variant;e(this.selectors.originalPrice).html(theme.Currency.formatMoney(o.price,StyleHatch.currencyFormat)),StyleHatch.currencyConverter&&(removeDataAttributes(e(this.selectors.originalPrice)),Currency.convertAll(StyleHatch.shopCurrency,e("[name=currencies]").val()),e(".selected-currency").text(Currency.currentCurrency)),o.compare_at_price>o.price?(e(this.selectors.comparePrice).find("span.money").html(theme.Currency.formatMoney(o.compare_at_price,StyleHatch.currencyFormat)),e(this.selectors.comparePrice).show()):e(this.selectors.comparePrice).hide()},_updateSKU:function(t){var o=t.variant;e(this.selectors.SKU).html(o.sku)},onUnload:function(){this.$container.off(this.settings.namespace),e.magnificPopup.close(),this.settings.zoomEnabled&&a(e(this.selectors.productImageWrap)),StyleHatch.ajaxCartEnable&&StyleHatch.AjaxCart.unload(),this.$container.destroyProductBox()}}),t}(),StyleHatch.Collection=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id");this.$sortSelect=e(a.sortSelection,o),this.defaultSort=this._getDefaultSortValue(),this.$viewButton=e(a.viewChange),this.$sortSelect.on("change",this._onSortChange.bind(this)),this.$viewButton.on("click",this._onViewChange),this.$productbox=e(a.productBox,o),this._initSidebar(),this._initAdvancedTags(),o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}var o={SORT_BY:"sort_by",DEFAULT_SORT:"title-ascending",VIEW:"view"},a={sortSelection:"#SortBy",defaultSort:".sort-by__default-sort",viewChange:".change-view",advancedFilter:".advanced-filter a",filterCollection:".mobile-aside-container > a.button.simple",mobileAside:".mobile-aside-container aside",productBox:".box.product .image-table",nestedMenu:"ul.nested-menu"};return t.prototype=e.extend({},t.prototype,{_onSortChange:function(e){var t="";this.sort=this._getSortValue(),this.sort!==this.defaultSort&&(t=[o.SORT_BY+"="+this.sort]);var a=document.URL,r=a.indexOf("?")>-1;if(r)document.location.href=replaceUrlParam(a,o.SORT_BY,this.sort);else{var n=document.location.search=t.length?"?"+t:"";document.location.href=this.$filterSelect.val()+n}},_getSortValue:function(){return this.$sortSelect.val()||this.defaultSort},_getDefaultSortValue:function(){return e(a.defaultSort,this.$container).val()||o.DEFAULT_SORT},_onViewChange:function(t){var o=e(this).data("view"),a=document.URL,r=a.indexOf("?")>-1;r?window.location=replaceUrlParam(a,"view",o):window.location=a+"?view="+o,t.preventDefault()},_initSidebar:function(){e(a.filterCollection).on("click",function(t){e(a.mobileAside).slideToggle(),t.preventDefault()}),this.$container.find(a.nestedMenu).initNestedMenu()},_initAdvancedTags:function(){var t,o,r,n,i=e(a.advancedFilter);i.on("click",function(a){t=e(this).parent(),o=t.data("group"),r=t.data("handle"),n=e('.active[data-group="'+o+'"]'),!t.hasClass("active")&&n.length&&(a.preventDefault(),location.href=location.href.replace(n.data("handle"),r).replace(/(&page=\d+)|(page=\d+&)|(\?page=\d+$)/,""))})},onUnload:function(){this.$sortSelect.off("change"),this.$viewButton.off("click"),e(a.advancedFilter).off("click"),this.$container.destroyProductBox(),this.$container.find(a.nestedMenu).destroyNestedMenu()}}),t}(),StyleHatch.ListCollections=function(){function t(t){var a=this.$container=e(t),r=(a.attr("data-section-id"),a.data("layout"));a.find(".card__image");this.$productbox=e(o.productBox,a),"preview"==r&&a.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}var o={productBox:".box .image-table"};return t.prototype=e.extend({},t.prototype,{onUnload:function(){$container.destroyProductBox()}}),t}(),StyleHatch.BlogArticle=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id");this._initSidebar(),StyleHatch.videoLayout()}var o={filterCollection:".mobile-aside-container > a.button.simple",mobileAside:".mobile-aside-container aside",nestedMenu:"ul.nested-menu"};return t.prototype=e.extend({},t.prototype,{_initSidebar:function(){e(o.filterCollection).on("click",function(t){e(o.mobileAside).slideToggle(),t.preventDefault()}),this.$container.find(o.nestedMenu).initNestedMenu()},onUnload:function(){e(o.filterCollection).off("click"),this.$container.find(o.nestedMenu).destroyNestedMenu()}}),t}(),StyleHatch.Password=function(){function t(t){var o=this.$container=e(t),a=(o.attr("data-section-id"),e("#login_form"));e(".login-popup").magnificPopup({type:"inline",midClick:!0,mainClass:"mfp-fade",closeBtnInside:!1,callbacks:{afterClose:function(){e("a").blur(),a.find(".errors").remove()}}}),e("#mc-embedded-subscribe-form").on("submit",function(){e("p.signup-message").hide(),e("p.thanks-message").show(),e(this).find(".input-row").hide()}),a.find(".errors").length>0&&e(".login-popup").magnificPopup("open")}return t.prototype=e.extend({},t.prototype,{onUnload:function(){e.magnificPopup.close(),e("#mc-embedded-subscribe-form").off("submit")}}),t}(),StyleHatch.Cart=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id");StyleHatch.quantitySelect()}return t.prototype=e.extend({},t.prototype,{onUnload:function(){}}),t}(),StyleHatch.AjaxCart=function(){function t(){p={$body:e(d.body),$util:e(d.util),$cartPreview:e(d.cartPreview),$addToCartForm:e(d.addToCartForm),$addToCartButton:e(d.addToCartButton),$cartButton:e(d.cartButton),$cartCount:e(d.cartCount),$cartCost:e(d.cartCost)}}function o(){t(),s()}function a(t){var t=t,o=t.find(".cart-error"),a=t.find("[data-AddToCartText]").html(),r=(t.find("[data-AddToCartText]").attr("data-added"),t.find("[data-AddToCartText]").attr("data-adding"));return t.find("[data-AddToCart]").addClass("added").prop("disabled",!0),t.find("[data-AddToCartText]").html(r),o.hide(),e.post(u.addURL,t.serialize(),function(o){var r=o;e.get(u.cartURL,function(e){var o=e;n(o),i(r,o);var s;s=setTimeout(function(){t.find("[data-AddToCart]").removeClass("added").prop("disabled",!1),t.find("[data-AddToCartText]").html(a)},500)},"json")},"text").error(function(e){if("undefined"!=typeof e&&"undefined"!=typeof e.status){var r=JSON.parse(e.responseText);o.html("<strong>"+r.message+":</strong> <em>"+r.description+"<em>"),o.slideDown()}var n;n=setTimeout(function(){t.find("[data-AddToCart]").removeClass("added").prop("disabled",!1),t.find("[data-AddToCartText]").html(a)},500)}),!1}function r(){e.post(u.clearURL)}function n(e){var t=(p.$cartButton,p.$cartCount),o=p.$cartCost,a=e.item_count,r=theme.Currency.formatMoney(e.total_price,StyleHatch.currencyFormat);t.text(a),o.removeClass("money"),o.html('<span class="money">'+r+"</span>"),StyleHatch.currencyConverter&&Currency.convertAll(StyleHatch.shopCurrency,jQuery("[name=currencies]").val())}function i(t,o){var a=p.$util,r=p.$cartPreview;clearTimeout(p.hideCartPreview),p.$cartPreview.hide();var n=o.item_count,i=theme.Currency.formatMoney(o.total_price,StyleHatch.currencyFormat),t=JSON.parse(t),s=t.product_title,l=t.variant_options,c=t.image,d=t.url,u=theme.Currency.formatMoney(t.price,StyleHatch.currencyFormat),h=(t.quantity,theme.Currency.formatMoney(t.line_price,StyleHatch.currencyFormat),r.find(".product-image").empty());h.append('<img src="'+c+'" alt="'+s+'">'),h.attr("href",d);var f=r.find(".product-title");f.html(s),f.attr("href",d);var y=r.find(".product-variant").empty();e.each(l,function(){var e=this;e.toLowerCase().indexOf("default title")<0?(y.show(),y.append("<li>"+e+"</li>")):y.hide()});var m=r.find(".product-price");m.removeClass("money"),m.html('<span class="money">'+u+"</span>");var g=r.find(".item-count");g.text(n),n>1?(r.find(".count.plural").show(),r.find(".count.singular").hide()):(r.find(".count.plural").hide(),r.find(".count.singular").show());var v=r.find(".total-price");v.html('<span class="money">'+i+"</span>");var b=a.height();r.css({top:b}),r.fadeIn(300),p.hideCartPreview=setTimeout(function(){r.fadeOut(300)},6e3),r.find("a.continue-shopping").on("click",function(e){r.fadeOut(300),e.preventDefault()}),StyleHatch.currencyConverter&&Currency.convertAll(StyleHatch.shopCurrency,jQuery("[name=currencies]").val())}function s(){p.$addToCartForm.each(function(){e(this).on("submit",function(t){var o=e(this);a(o),t.preventDefault()})})}function l(){p.$addToCartForm.off("submit")}function c(){l(),clearTimeout(p.hideCartPreview),p.$cartPreview.hide()}var d={body:"body",util:"header.util",cartPreview:"header.util .cart-preview",addToCartForm:"[data-AddToCartForm] > form",addToCartButton:"[data-AddToCartForm]",cartButton:"[data-CartButton]",cartCount:"#CartCount",cartCost:"#CartCost"},u={addURL:"/cart/add.js",cartURL:"/cart.js",clearURL:"/cart/clear.js"},p={};return{init:o,clearCart:r,unload:c}}(),StyleHatch.CurrencyConverter=function(){function t(){i={$body:e(r.body),$money:e(r.money)}}function o(){t(),a()}function a(){n.cookieCurrency=Currency.cookie.read(),e("span.money span.money").each(function(){e(this).parents(r.money).removeClass("money")}),i.$money.each(function(){""!==Currency.currentCurrency?e(this).attr("data-currency-"+Currency.currentCurrency,e(this).html()):e(this).attr("data-currency-"+StyleHatch.shopCurrency,e(this).html())}),null==n.cookieCurrency?StyleHatch.shopCurrency!==StyleHatch.defaultCurrency?Currency.convertAll(StyleHatch.shopCurrency,StyleHatch.defaultCurrency):Currency.currentCurrency=StyleHatch.defaultCurrency:e("[name=currencies]").length&&0===e("[name=currencies] option[value="+n.cookieCurrency+"]").length?(Currency.currentCurrency=StyleHatch.shopCurrency,Currency.cookie.write(StyleHatch.shopCurrency)):n.cookieCurrency===StyleHatch.shopCurrency?Currency.currentCurrency=StyleHatch.shopCurrency:Currency.convertAll(StyleHatch.shopCurrency,n.cookieCurrency),e("[name=currencies]").val(Currency.currentCurrency).change(function(){var t=e(this).val();Currency.convertAll(Currency.currentCurrency,t),e(".selected-currency").text(Currency.currentCurrency),e("p.currency-at-checkout").length>0&&(Currency.currentCurrency==StyleHatch.shopCurrency?e("p.currency-at-checkout").hide():e("p.currency-at-checkout").show())}),e("[name=currencies]").val(Currency.currentCurrency).change()}var r={body:"body",money:"span.money"},n={enabled:!1},i={};return{init:o,config:n,convert:a}}(),window.theme=window.theme||{},window.slate=window.slate||{},theme.Images=function(){function e(e,t){"string"==typeof e&&(e=[e]);for(var o=0;o<e.length;o++){var a=e[o];this.loadImage(this.getSizedImageUrl(a,t))}}function t(e){(new Image).src=e}function o(e,t,o){var a=this.imageSize(t.src),r=this.getSizedImageUrl(e.src,a);o?o(r,e,t):t.src=r}function a(e){var t=e.match(/.+_((?:pico|icon|thumb|small|compact|medium|large|grande)|\d{1,4}x\d{0,4}|x\d{1,4})[_\.@]/);return null!==t?t[1]:null}function r(e,t){if(null==t)return e;if("master"===t)return this.removeProtocol(e);var o=e.match(/\.(jpg|jpeg|gif|png|bmp|bitmap|tiff|tif)(\?v=\d+)?$/i);if(null!=o){var a=e.split(o[0]),r=o[0];return this.removeProtocol(a[0]+"_"+t+r)}return null}function n(e){return e.replace(/http(s)?:/,"")}return{preload:e,loadImage:t,switchImage:o,imageSize:a,getSizedImageUrl:r,removeProtocol:n}}(),theme.Currency=function(){function e(e,o){function a(e,t,o,a){if(t=slate.utils.defaultTo(t,2),o=slate.utils.defaultTo(o,","),a=slate.utils.defaultTo(a,"."),isNaN(e)||null==e)return 0;e=(e/100).toFixed(t);var r=e.split("."),n=r[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1"+o),i=r[1]?a+r[1]:"";return n+i}"string"==typeof e&&(e=e.replace(".",""));var r="",n=/\{\{\s*(\w+)\s*\}\}/,i=o||t;switch(i.match(n)[1]){case"amount":r=a(e,2);break;case"amount_no_decimals":r=a(e,0);break;case"amount_with_comma_separator":r=a(e,2,".",",");break;case"amount_no_decimals_with_comma_separator":r=a(e,0,".",",");break;case"amount_no_decimals_with_space_separator":r=a(e,0," ")}return i.replace(n,r)}var t="${{amount}}";return{formatMoney:e}}(),slate.utils={findInstance:function(e,t,o){for(var a=0;a<e.length;a++)if(e[a][t]===o)return e[a]},removeInstance:function(e,t,o){for(var a=e.length;a--;)if(e[a][t]===o){e.splice(a,1);break}return e},compact:function(e){for(var t=-1,o=null==e?0:e.length,a=0,r=[];++t<o;){var n=e[t];n&&(r[a++]=n)}return r},defaultTo:function(e,t){return null==e||e!==e?t:e},debounce:function(e,t,o){var a;return function(){var r=this,n=arguments,i=function(){a=null,o||e.apply(r,n)},s=o&&!a;clearTimeout(a),a=setTimeout(i,t),s&&e.apply(r,n)}}},slate.Variants=function(){function t(t){this.$container=t.$container,this.product=t.product,this.singleOptionSelector=t.singleOptionSelector,this.originalSelectorId=t.originalSelectorId,this.enableHistoryState=t.enableHistoryState,this.currentVariant=this._getVariantFromOptions(),e(this.singleOptionSelector,this.$container).on("change",this._onSelectChange.bind(this))}return t.prototype=e.extend({},t.prototype,{_getCurrentOptions:function(){var t=e.map(e(this.singleOptionSelector,this.$container),function(t){var o=e(t),a=o.attr("type"),r={};return"radio"===a||"checkbox"===a?!!o[0].checked&&(r.value=o.val(),r.index=o.data("index"),r):(r.value=o.val(),r.index=o.data("index"),r)});return t=slate.utils.compact(t)},_getVariantFromOptions:function(){var e=this._getCurrentOptions(),t=this.product.variants,o=!1;return t.forEach(function(t){var a=!0;t.options;e.forEach(function(e){a&&(a=e.value===t[e.index])}),a&&(o=t)}),o||null},_onSelectChange:function(){var e=this._getVariantFromOptions();this.$container.trigger({type:"variantChange",variant:e}),e&&(this._updateMasterSelect(e),this._updateImages(e),this._updatePrice(e),this._updateSKU(e),this.currentVariant=e,this.enableHistoryState&&this._updateHistoryState(e))},_updateImages:function(e){var t=e.featured_image||{},o=this.currentVariant.featured_image||{};e.featured_image&&t.src!==o.src&&this.$container.trigger({type:"variantImageChange",variant:e})},_updatePrice:function(e){e.price===this.currentVariant.price&&e.compare_at_price===this.currentVariant.compare_at_price||this.$container.trigger({type:"variantPriceChange",variant:e})},_updateSKU:function(e){e.sku!==this.currentVariant.sku&&this.$container.trigger({type:"variantSKUChange",variant:e})},_updateHistoryState:function(e){if(history.replaceState&&e){var t=window.location.protocol+"//"+window.location.host+window.location.pathname+"?variant="+e.id;window.history.replaceState({path:t},"",t)}},_updateMasterSelect:function(t){e(this.originalSelectorId,this.$container)[0].value=t.id}}),t}(),e.fn.extend({productBox:function(){var t=e(this).find(".box.product figure");t.on("click",function(t){if(e(t.target).is(".vendor")||e(t.target).parent().is(".vendor"));else{t.preventDefault();var o=e(this).find("a").attr("href");t.shiftKey||t.ctrlKey||t.metaKey?window.open(o,"_blank"):window.location=o}}),Modernizr.objectfit||t.find(".product_card__image-wrapper").each(function(){var t=e(this),o=t.find(".product_card__image.alt");t.find("img").prop("src");o.hide(),t.addClass("ie-fallback lazyload")})},destroyProductBox:function(){var t=e(this).find(".box.product figure");t.off("click")},initNestedMenu:function(){var t=e(this),o=t.find('a[aria-haspopup="true"]'),a=function(e){var t=e.find("li.has-dropdown.expanded");if(t.length>0){t.removeClass("expanded");var o=t.find("> a");o.attr("aria-expanded","false");var a=t.find("> ul.dropdown");a.attr("aria-hidden","true"),a.slideUp();var n=a.find("a");n.attr("tabindex","-1"),r(e)}},r=function(e){var t=e.find("li.has-sub-dropdown.expanded");if(t.length>0){t.removeClass("expanded");var o=t.find("> a");o.attr("aria-expanded","false");var a=t.find("> ul.sub-dropdown");a.attr("aria-hidden","true"),a.slideUp();var n=a.find("a");n.attr("tabindex","-1"),r(e)}};o.on("click",function(t){var o=e(this),n=o.parent(),i=n.find("> ul"),s=n.find("> ul > li > a"),l=o.closest("ul.nested-menu");"true"!==o.attr("aria-expanded")&&(t.preventDefault(),n.hasClass("has-dropdown")?a(l):r(l),o.attr("aria-expanded","true"),n.addClass("expanded"),i.attr("aria-hidden","false"),s.attr("tabindex","0"),i.slideDown())})},destroyNestedMenu:function(){var t=e(this),o=t.find('a[aria-haspopup="true"]');o.off("click")}}),StyleHatch.refreshFixTo=function(){StyleHatch.Promos.refreshFixTo();var t=e("*").filter(function(){return e(this).data("fixtoInstance")});t.each(function(t){e(this).data("fixto-instance")._running&&e(this).fixTo("refresh")})},StyleHatch.videoLayout=function(){e(".rte").fitVids()},StyleHatch.loginForms=function(){function e(){StyleHatch.cache.$recoverPasswordForm.show(),StyleHatch.cache.$customerLoginForm.hide()}function t(){StyleHatch.cache.$recoverPasswordForm.hide(),StyleHatch.cache.$customerLoginForm.show()}StyleHatch.cache.$recoverPasswordLink.on("click",function(t){t.preventDefault(),e(),StyleHatch.updateHash("recover")}),StyleHatch.cache.$hideRecoverPasswordLink.on("click",function(e){e.preventDefault(),t(),StyleHatch.updateHash()}),"#recover"==StyleHatch.getHash()&&e()},StyleHatch.initTemplates=function(){var e=StyleHatch.cache.$body,t=e.data("template");switch(t){case"addresses":StyleHatch.initCustomerAddressTemplate()}},StyleHatch.initCustomerAddressTemplate=function(){if(StyleHatch.addressJSValidation){var t=e('.customer-address input[type="submit"]');t.on("click",function(t){var o=e(this).closest("form"),a=o.find('input[name="address[last_name]"]'),r=o.find('input[name="address[address1]"]'),n=o.find('input[name="address[city]"]'),i=o.find('select[name="address[country]"]'),s=o.find('select[name="address[province]"]'),l=o.find('input[name="address[zip]"]');a.val()||a.addClass("required"),r.val()||r.addClass("required"),n.val()||n.addClass("required"),"---"==i.val()&&i.addClass("required"),s.closest(".input-row").is(":visible")&&(s.val()&&"---"!=s.val()&&""!=s.val()||s.addClass("required")),l.val()||l.addClass("required");var c=o.find("input.required, select.required");c.on("focus",function(){e(this).removeClass("required")}),c.length>0?(o.find("div.errors").parent().show(),t.preventDefault()):o.find("div.errors").parent().hide()})}},StyleHatch.updateHash=function(t){t?(window.location.hash="#"+t,e("#"+t).attr("tabindex",-1).focus()):window.location.hash=""},StyleHatch.getHash=function(){return window.location.hash},StyleHatch.quantitySelect=function(){var t=e(".quantity-select");t.each(function(){var t=e(this),o=t.find(".adjust-minus"),a=t.find(".adjust-plus"),r=t.find("input.quantity"),n=r.val();o.on("click",function(e){n=r.val(),n>1&&(n--,r.val(n)),e.preventDefault()}),a.on("click",function(e){n=r.val(),n++,r.val(n),e.preventDefault()})})},StyleHatch.resetPasswordSuccess=function(){StyleHatch.cache.$passwordResetSuccess.show()},e(document).ready(function(){StyleHatch.init()})}(jq223);

!function(e){"use strict";window.StyleHatch=window.StyleHatch||{},StyleHatch.Sections=function(){this.constructors={},this.instances=[],e(document).on("shopify:section:load",this._onSectionLoad.bind(this)).on("shopify:section:unload",this._onSectionUnload.bind(this)).on("shopify:section:select",this._onSelect.bind(this)).on("shopify:section:deselect",this._onDeselect.bind(this)).on("shopify:section:reorder",this._onReorder.bind(this)).on("shopify:block:select",this._onBlockSelect.bind(this)).on("shopify:block:deselect",this._onBlockDeselect.bind(this))},StyleHatch.Sections.prototype=e.extend({},StyleHatch.Sections.prototype,{_createInstance:function(t,o){var a=e(t),r=a.attr("data-section-id"),n=a.attr("data-section-type");if(void 0!==(o=o||this.constructors[n])){var i=e.extend(new o(t),{id:r,type:n,container:t});this.instances.push(i)}},_onSectionLoad:function(t){var o=e("[data-section-id]",t.target)[0];o&&this._createInstance(o)},_onSectionUnload:function(e){var t=slate.utils.findInstance(this.instances,"id",e.detail.sectionId);t&&("function"==typeof t.onUnload&&t.onUnload(e),this.instances=slate.utils.removeInstance(this.instances,"id",e.detail.sectionId))},_onSelect:function(t){var o=slate.utils.findInstance(this.instances,"id",t.detail.sectionId);o&&"function"==typeof o.onSelect&&o.onSelect(t),e("body").hasClass("panel-open")&&(StyleHatch.closePanelMenu(),e("html, body").addClass("scroll-lock"),setTimeout(function(){e("html, body").removeClass("scroll-lock"),e("html, body").animate({scrollTop:o.$container.offset().top},600)},400))},_onDeselect:function(t){var o=slate.utils.findInstance(this.instances,"id",t.detail.sectionId);o&&"function"==typeof o.onDeselect&&o.onDeselect(t),e("body").hasClass("panel-open")&&StyleHatch.closePanelMenu()},_onReorder:function(e){var t=slate.utils.findInstance(this.instances,"id",e.detail.sectionId);t&&"function"==typeof t.onReorder&&t.onReorder(e)},_onBlockSelect:function(e){var t=slate.utils.findInstance(this.instances,"id",e.detail.sectionId);t&&"function"==typeof t.onBlockSelect&&t.onBlockSelect(e)},_onBlockDeselect:function(e){var t=slate.utils.findInstance(this.instances,"id",e.detail.sectionId);t&&"function"==typeof t.onBlockDeselect&&t.onBlockDeselect(e)},register:function(t,o){this.constructors[t]=o,e("[data-section-type="+t+"]").each(function(e,t){this._createInstance(t,o)}.bind(this))}}),StyleHatch.cacheSelectors=function(){StyleHatch.cache={$body:e("body"),$html:e("html"),$util:e("header.util"),$header:e("header.site-header"),$siteNav:e("header.site-header ul.site-nav"),$featuredCollection:e(".featured-collection"),$instagramCollection:e(".instagram-collection"),$addToCartForm:e("#AddToCartForm"),$addToCartButton:e("#AddToCart"),$cartButton:e("#CartButton"),$recoverPasswordLink:e("#RecoverPassword"),$hideRecoverPasswordLink:e("#HideRecoverPasswordLink"),$recoverPasswordForm:e("#RecoverPasswordForm"),$customerLoginForm:e("#CustomerLoginForm"),$passwordResetSuccess:e("#ResetSuccess")}},StyleHatch.init=function(){document.documentElement.setAttribute("data-useragent",navigator.userAgent),StyleHatch.cacheSelectors(),StyleHatch.largeMobile=700;var t=new StyleHatch.Sections;t.register("promos-section",StyleHatch.PromosSection),t.register("header-section",StyleHatch.HeaderSection),t.register("footer-section",StyleHatch.FooterSection),t.register("slideshow-section",StyleHatch.SlideshowSection),t.register("hero-video-section",StyleHatch.HeroVideoSection),t.register("featured-collection-section",StyleHatch.FeaturedCollectionSection),t.register("simple-collection-section",StyleHatch.SimpleCollectionSection),t.register("featured-text-section",StyleHatch.PageSection),t.register("custom-content-section",StyleHatch.PageSection),t.register("instagram-section",StyleHatch.InstagramSection),t.register("featured-blog-section",StyleHatch.GenericSection),t.register("map",StyleHatch.Maps),t.register("product-template",StyleHatch.Product),t.register("collection-template",StyleHatch.Collection),t.register("collection-list-template",StyleHatch.Collection),t.register("list-collections-template",StyleHatch.ListCollections),t.register("blog-template",StyleHatch.BlogArticle),t.register("article-template",StyleHatch.BlogArticle),t.register("password-template",StyleHatch.Password),t.register("cart-template",StyleHatch.Cart),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init(),StyleHatch.ajaxCartEnable&&StyleHatch.AjaxCart.init(),StyleHatch.loginForms(),StyleHatch.videoLayout(),StyleHatch.initTemplates(),e("main").productBox()},StyleHatch.PromosSection=function(){return function(t){(this.$container=e(t)).attr("data-section-id"),StyleHatch.Promos.init()}}(),StyleHatch.PromosSection.prototype=e.extend({},StyleHatch.PromosSection.prototype,{onUnload:function(){StyleHatch.Promos.unload()},onBlockSelect:function(e){StyleHatch.Promos.blockSelect(e)},onBlockDeselect:function(e){StyleHatch.Promos.blockDeselect(e)}}),StyleHatch.Promos=function(){function t(){r.$promos.data("fixtoInstance")&&r.$promos.fixTo("destroy")}var o={body:"body",page:"#page",promos:"#shopify-section-promos",promoBar:"header.promo-bar",bottomContainer:".promo-bar-container.bottom",popup:".promo-popup"},a={};a={scrollLock:!1,fixToZIndex:992,hideTimers:[],slideSpeed:400};var r={};return e.fn.extend({showPopup:function(t){var o=e(this),a=!0,n=(o.data("show-delay"),o.data("show-again-delay")),i=o.data("homepage-limit"),s=o.data("visitor-limit"),l=o.data("visitor"),c=(o.data("show-for"),o.data("type"));1==s&&0==l&&(a=!1);var d="popup-"+o.data("id");e.cookie(d)&&(a=!1),i&&!r.$body.hasClass("template-index")&&(a=!1),window.self!==window.top&&"popup"==c&&(a=!1),t&&(a=!0);var u=o.find(".errors"),p=getQueryString("contact%5Btags%5D");(u.length&&p.includes("popup")&&(a=!0,o.find("input#email").addClass("errors")),u.length&&p.includes("signup-bar")&&(a=!0),Modernizr.touchevents&&o.find("form").removeAttr("target"),a)&&("popup"==c&&e.magnificPopup.open({items:{src:o,type:"inline",showCloseBtn:!1},mainClass:"mfp-slideup",removalDelay:300,callbacks:{close:function(){e.cookie(d,"shown",{expires:n,path:"/"})}}}),"signup-bar"==c&&(t?o.addClass("visible force"):o.addClass("visible")),o.find(".icon-text").on("click",function(e){o.hidePopup(),e.preventDefault()}),o.find("form").on("submit",function(t){return!!t.target.checkValidity()&&(o.hidePopup(),void e(this).submit())}))},hidePopup:function(){var t=(e("#shopify-section-promos"),e(this)),o=t.data("type"),a=t.data("id");if("popup"==o&&e.magnificPopup.close(),"signup-bar"==o){var r="popup-"+a;e.cookie(r,"shown",{expires:60,path:"/"}),e(".promo-bar.signup-bar").each(function(t){e(this).slideUp({duration:400,progress:function(){StyleHatch.refreshFixTo()},complete:function(){StyleHatch.refreshFixTo(),e(this).removeClass("visible force")}})})}},promoSlideUp:function(){e(this).slideUp({duration:a.slideSpeed,progress:StyleHatch.refreshFixTo,complete:StyleHatch.refreshFixTo})},promoSlideDown:function(){e(this).slideDown({duration:a.slideSpeed,progress:StyleHatch.refreshFixTo,complete:StyleHatch.refreshFixTo})},showMockPopup:function(){var t=e("#shopify-section-promos");e(".mock-popup-container").length||t.find(">*:first").append('<div class="mock-popup-container"></div>');var o=e(".mock-popup-container"),a=e(this);a.appendTo(o),o.show(),a.show()},hideMockPopup:function(){var t=e(".mock-popup-container"),o=e(this);t.hide(),o.hide()}}),{init:function(){r={$body:e(o.body),$promos:e(o.promos),$promosContainer:e(o.promos).find(">*:first"),$promoBar:e(o.promoBar),$bottomContainer:e(o.bottomContainer),$popup:e(o.popup)},a.scrollLock=r.$promos.find(">*:first").data("scroll-lock"),r.$promoBar.length&&(r.$promoBar.each(function(){var t=e(this),n=t.data("hide-delay"),i=t.data("bar-placement"),s=t.find("div.errors");s.length&&s.prependTo(t),"bottom"==i&&(r.$bottomContainer.length||(r.$promosContainer.append('<div class="promo-bar-container bottom"></div>'),r.$bottomContainer=e(o.bottomContainer)),t.appendTo(r.$bottomContainer),r.$bottomContainer.resize(function(){var t=e(this).height()+"px";r.$body.css({"margin-bottom":t})})),t.hasClass("signup-bar")&&t.showPopup(),"no-delay"!==n&&a.hideTimers.push(setTimeout(function(){t.data("pause-hide")||t.promoSlideUp()},n))}),t(),a.scrollLock&&r.$promos.fixTo(o.page,{zIndex:a.fixToZIndex})),r.$popup.length&&r.$popup.each(function(){var t=e(this),o=t.data("show-delay"),a=(t.data("homepage-limit"),t.data("visitor-limit"),t.data("visitor"),t.data("show-for")),r=t.find(".errors");r.length&&(o=0),setTimeout(function(){var o=e(window).width();switch(a){case"mobile":o<=StyleHatch.largeMobile&&t.showPopup();break;case"desktop":o>StyleHatch.largeMobile&&t.showPopup();break;case"both":t.showPopup()}},o)}),StyleHatch.Header.rebuildFixTo()},unload:function(){if(void 0!==a.hideTimers&&a.hideTimers instanceof Array){for(var o=0;o<a.hideTimers.length;o++)clearTimeout(a.hideTimers[o]);a.hideTimers.length=0}else a.hideTimers=[];t(),StyleHatch.refreshFixTo(),r.$bottomContainer.remove(),e.magnificPopup.close()},blockSelect:function(t){var o=e("#block-"+t.detail.blockId),a=o.data("type");switch(e.magnificPopup.close(),a){case"announcement-bar":o.promoSlideDown(),o.attr("data-pause-hide",!0);break;case"popup":o.showMockPopup();break;case"signup-bar":o.showPopup(!0)}StyleHatch.Header.rebuildFixTo(),StyleHatch.refreshFixTo()},blockDeselect:function(t){var o=e("#block-"+t.detail.blockId),r=o.data("type"),n=o.data("show-for"),i=e(window).width();switch(r){case"announcement-bar":var s=o;s.attr("data-pause-hide",!1);var l=s.data("hide-delay");s.data("bar-placement"),s.data("homepage-limit"),"desktop"==n&&i<=StyleHatch.largeMobile?o.promoSlideUp():"mobile"==n&&i>StyleHatch.largeMobile&&o.promoSlideUp(),"no-delay"!==l&&a.hideTimers.push(setTimeout(function(){s.data("pause-hide")||s.promoSlideUp()},l));break;case"popup":o.hideMockPopup();break;case"signup-bar":"desktop"==n&&i<=StyleHatch.largeMobile&&(o.hidePopup(),StyleHatch.refreshFixTo()),"mobile"==n&&i>StyleHatch.largeMobile&&(o.hidePopup(),StyleHatch.refreshFixTo())}StyleHatch.Header.rebuildFixTo()},refreshFixTo:function(){r.$promos.data("fixtoInstance")&&r.$promos.fixTo("refresh")}}}(),StyleHatch.HeaderSection=function(){return function(t){(this.$container=e(t)).attr("data-section-id"),StyleHatch.Header.init()}}(),StyleHatch.HeaderSection.prototype=e.extend({},StyleHatch.HeaderSection.prototype,{onUnload:function(){StyleHatch.Header.unload()}}),StyleHatch.Header=function(){function t(){f={$htmlBody:e(p.htmlBody),$body:e(p.body),$page:e(p.page),$section:e(p.section),$promosSection:e(p.promosSection),$util:e(p.util),$header:e(p.header),$siteNav:e(p.siteNav),$dropdownParent:e(p.siteNav).find("li.has-dropdown"),$defaultLink:e(p.siteNav).find("> li:not(.has-dropdown)"),$subMenuLinks:e(p.siteNav).find("li.has-dropdown a"),$subDropdownParent:e(p.siteNav).find("li.has-sub-dropdown"),$search:e(p.util).find(".search-wrapper"),$searchLink:e(p.util).find("a.search"),$searchClose:e(p.util).find("form.search-bar button"),$searchInput:e(p.util).find("form.search-bar input"),$menuLink:e(p.menuLink),$menuPanel:e(p.menuPanel),$menuPanelDropdown:e(p.menuPanel).find("li.has-dropdown"),$menuPanelSubDropdown:e(p.menuPanel).find("li.has-sub-dropdown")}}function o(){f.$search.slideDown({duration:h.slideSpeed,progress:function(){StyleHatch.refreshFixTo()},complete:function(){StyleHatch.refreshFixTo()}}),f.$searchInput.focus()}function a(){f.$searchInput.blur(),clearTimeout(h.blurTimer),f.$search.slideUp({duration:h.slideSpeed,progress:function(){StyleHatch.refreshFixTo()},complete:function(){StyleHatch.refreshFixTo()}})}function r(){f.$body.hasClass("panel-open")?i():n()}function n(){f.$htmlBody.addClass("panel-open"),window.scrollTo(0,0),f.$menuPanel.attr("tabindex","0"),f.$menuPanel.focus()}function i(){f.$htmlBody.addClass("panel-open-transition"),f.$htmlBody.removeClass("panel-open"),f.$menuPanel.removeAttr("tabindex"),setTimeout(function(){f.$htmlBody.removeClass("panel-open-transition")},400)}function s(e){e.removeClass(h.dropdownActiveClass),f.$body.off("touchstart"),e.find("> a").attr("aria-expanded","false"),e.find("ul.dropdown").attr("aria-hidden","true"),e.find("ul.dropdown > li > a").attr("tabindex","-1")}function l(t){s(e("."+h.subDropdownActiveClass)),t.addClass(h.subDropdownActiveClass),t.find("> a").attr("aria-expanded","true"),t.find("ul.sub-dropdown").attr("aria-hidden","false"),t.find("ul.sub-dropdown > li > a").attr("tabindex","0"),t.find(".sub-dropdown").offset().left+t.find(".sub-dropdown").width()>e(window).width()?t.addClass("alternate-align"):t.removeClass("alternate-align")}function c(e){e.removeClass(h.subDropdownActiveClass),e.removeClass("alternate-align"),e.find("> a").attr("aria-expanded","false"),e.find("ul.sub-dropdown").attr("aria-hidden","true"),e.find("ul.sub-dropdown > li > a").attr("tabindex","-1")}function d(){var t=e("header.util, #shopify-section-header").filter(function(){return e(this).data("fixtoInstance")});t.length&&t.fixTo("destroy")}function u(){t(),d(),function(){var t=f.$section,o=f.$promosSection,a=f.$header,r=f.$util,n=a.data("scroll-lock");if("util"==n||"header"==n){var i="";o.data("fixtoInstance")&&(i="#shopify-section-promos"),r.fixTo("#page",{zIndex:991,mind:i})}"header"==n&&(i="header.util",o.data("fixtoInstance")&&(i="header.util, #shopify-section-promos"),t.fixTo("#page",{zIndex:990,mind:i}),t.resize(function(){e(this).width()<=700?t.fixTo("stop"):t.fixTo("start")}))}()}var p={htmlBody:"html, body",body:"body",page:"#page",section:"#shopify-section-header",promosSection:"#shopify-section-promos",util:"header.util",header:"header.site-header",siteNav:"header.site-header ul.site-nav",menuLink:".menu-link",menuPanel:"#menu.panel",menuOverlay:".mobile-menu-overlay"},h={};h={blurTimer:{},blurTime:2e3,slideSpeed:300,dropdownActiveClass:"dropdown-hover",subDropdownActiveClass:"sub-dropdown-hover"};var f={};return{init:function(){t(),e(p.menuOverlay).length||(f.$section.append('<div class="mobile-menu-overlay"></div>'),f.$menuOverlay=e(p.menuOverlay)),f.$searchLink.on("click.search",function(e){o(),e.preventDefault()}),f.$searchClose.on("click.search",function(e){a(),e.preventDefault()}),f.$searchInput.on("blur.search",function(e){h.blurTimer=setTimeout(a,h.blurTime),e.preventDefault()}),f.$menuLink.on("click.panel",function(e){r(),e.preventDefault()}),f.$menuOverlay.on("click.panel",function(e){r(),e.preventDefault()}),f.$menuPanelDropdown.on("click.panelDropdown",function(t){f.$menuPanelDropdown.find("ul.dropdown").slideUp(),f.$menuPanelDropdown.find("> a").attr("aria-expanded","false"),f.$menuPanelDropdown.removeClass("expanded"),f.$menuPanelDropdown.find("ul.dropdown").attr("aria-hidden","true"),f.$menuPanelDropdown.find("ul.dropdown a").attr("tabindex","-1"),e(this).find("ul.dropdown").is(":visible")||(e(this).find("> a").attr("aria-expanded","true"),e(this).find("ul.dropdown").slideDown(),e(this).find("ul.dropdown").attr("aria-hidden","false"),e(this).find("ul.dropdown > li > a").attr("tabindex","0"),e(this).addClass("expanded"))}),f.$menuPanelDropdown.find("> a").on("click.panelDropdown",function(t){e(this).closest("li").hasClass("expanded")||t.preventDefault()}),f.$menuPanelDropdown.find("ul.dropdown li:not(.has-sub-dropdown) a").on("click.panelDropdown",function(e){e.stopPropagation()}),f.$menuPanelSubDropdown.on("click.panelDropdown",function(t){t.stopPropagation(),f.$menuPanelSubDropdown.find("ul.sub-dropdown").slideUp(),f.$menuPanelDropdown.find("> a").attr("aria-expanded","false"),f.$menuPanelSubDropdown.removeClass("expanded"),f.$menuPanelDropdown.find("ul.sub-dropdown").attr("aria-hidden","true"),f.$menuPanelDropdown.find("ul.sub-dropdown a").attr("tabindex","-1"),e(this).find("ul.sub-dropdown").is(":visible")||(e(this).find("> a").attr("aria-expanded","true"),e(this).find("ul.sub-dropdown").slideDown(),e(this).find("ul.sub-dropdown").attr("aria-hidden","false"),e(this).find("ul.sub-dropdown > li > a").attr("tabindex","0"),e(this).addClass("expanded"))}),f.$menuPanelSubDropdown.find("> a").on("click.panelDropdown",function(t){e(this).closest("li").hasClass("expanded")||t.preventDefault()}),f.$menuPanelSubDropdown.find("ul.sub-dropdown a").on("click.panelDropdown",function(e){e.stopPropagation()}),f.$promosSection.resize(StyleHatch.refreshFixTo),f.$subMenuLinks.each(function(){var t=e(this),o=t.text(),a=wordWrapper(o,24,"<br/>\n");t.html(a)}),s(f.$dropdownParent),f.$dropdownParent.on("mouseenter.dropdown touchstart.dropdown focusin.dropdown",function(t){var o=e(this);o.hasClass(h.dropdownActiveClass)||(t.preventDefault(),function(t){s(e("."+h.dropdownActiveClass)),t.addClass(h.dropdownActiveClass),t.find("> a").attr("aria-expanded","true"),t.find("ul.dropdown").attr("aria-hidden","false"),t.find("ul.dropdown > li > a").attr("tabindex","0");var o=t.find("ul.dropdown");o.css({left:"auto"});var a=o.offset().left+o.outerWidth(),r=e(window).width()-20,n=f.$header.width(),i=f.$header.find(".logo-nav-contain").offset().left;if(n+40>e(window).width()&&(n=e(window).width(),i=-20),a>(r=n+i+1)){var l="-"+(a-r)+"px";o.css({left:l})}setTimeout(function(){f.$body.on("touchstart",function(){s(t)})},250)}(o))}),f.$dropdownParent.on("mouseleave.dropdown",function(){s(e(this))}),f.$subMenuLinks.on("touchstart.dropdown",function(e){e.stopImmediatePropagation()}),f.$subDropdownParent.on("mouseenter.subdropdown touchstart.subdropdown focusin.subdropdown",function(t){var o=e(this);o.hasClass(h.subDropdownActiveClass)||(t.preventDefault(),l(o))}),f.$subDropdownParent.on("mouseleave.subdropdown",function(){c(e(this))}),f.$subDropdownParent.on("touchstart.subdropdown",function(e){e.stopImmediatePropagation()}),e("html").hasClass("touchevents")&&f.$subDropdownParent.children("a").on("click",function(t){var o=e(this);o.hasClass(h.subDropdownActiveClass)||(t.preventDefault(),l(o))}),f.$subMenuLinks.on("focusout.dropdown",function(t){null==t.relatedTarget?s(e("."+h.dropdownActiveClass)):(e(t.target).closest("li.has-dropdown")[0]!==e(t.relatedTarget).closest("li.has-dropdown")[0]&&s(e("."+h.dropdownActiveClass)),e(t.target).closest("li.has-sub-dropdown")[0]!==e(t.relatedTarget).closest("li.has-sub-dropdown")[0]&&c(e("."+h.subDropdownActiveClass)))}),u()},unload:function(){i(),clearTimeout(h.blurTimer),f.$searchLink.off("click.search"),f.$searchClose.off("click.search"),f.$searchInput.off("blur.search"),f.$menuLink.off("click.panel"),f.$menuPanelDropdown.off("click.panelDropdown"),f.$menuPanelDropdown.find("> a").off("click.panelDropdown"),f.$menuPanelDropdown.find("ul.dropdown li:not(.has-sub-dropdown) a").off("click.panelDropdown"),f.$menuPanelSubDropdown.off("click.panelDropdown"),f.$menuPanelSubDropdown.find("> a").off("click.panelDropdown"),f.$menuPanelSubDropdown.find("ul.sub-dropdown a").off("click.panelDropdown"),f.$promosSection.removeResize(StyleHatch.refreshFixTo),f.$dropdownParent.off("mouseenter.dropdown touchstart.dropdown focusin.dropdown"),f.$dropdownParent.off("mouseleave.dropdown"),f.$subMenuLinks.off("touchstart.dropdown"),f.$subDropdownParent.off("mouseenter.subdropdown touchstart.subdropdown focusin.subdropdown"),f.$subDropdownParent.off("mouseleave.subdropdown"),f.$subDropdownParent.off("touchstart.subdropdown"),f.$subMenuLinks.off("focusout.dropdown"),d()},openSearch:o,closeSearch:a,togglePanelMenu:r,openPanelMenu:n,closePanelMenu:i,rebuildFixTo:u}}(),StyleHatch.FooterSection=function(){return function(t){var o=this.$container=e(t);o.attr("data-section-id"),StyleHatch.Footer.init(o)}}(),StyleHatch.FooterSection.prototype=e.extend({},StyleHatch.FooterSection.prototype,{onUnload:function(e){StyleHatch.Footer.unload(e)}}),StyleHatch.Footer=function(){return{init:function(e){e.find("ul.nested-menu").initNestedMenu()},unload:function(e){$nestedMenu.destroyNestedMenu()}}}(),StyleHatch.SlideshowSection=function(){return function(t){var o=this.$container=e(t);o.attr("data-section-id"),StyleHatch.Slideshow.init(o)}}(),StyleHatch.SlideshowSection.prototype=e.extend({},StyleHatch.SlideshowSection.prototype,{onUnload:function(e){StyleHatch.Slideshow.unload(e)},onBlockSelect:function(e){StyleHatch.Slideshow.blockSelect(e)},onBlockDeselect:function(e){StyleHatch.Slideshow.blockDeselect(e)}}),StyleHatch.Slideshow=function(){return{init:function(t){var o=t.find(".slideshow-carousel"),a=o.find(".slide__item");e(window).on("resize",function(){a.each(function(t){var o;e(window).width()>700?o=e(this).find("img.slide__image-desktop"):(o=e(this).find("img.slide__image-mobile")).length<1&&(o=e(this).find("img.slide__image-desktop")),o.hasClass("lazymanual")&&(o.attr("src",o.attr("data-preload")).removeAttr("data-preload"),o.removeClass("lazymanual").addClass("lazyload"))})}),e(window).trigger("resize");var r=o.data("flickity-options");o.flickity(r),window.addEventListener("touchmove",function(){}),t.find(".slide__item-video").each(function(){var t=e(this).find(".slide__item-image"),o=e(this).data("video-id"),a=0;e(this).data("mobile-autoplay")&&(a=1),t.YTPlayer({fitToBackground:!1,videoId:o,repeat:!0,mute:!0,playerVars:{rel:0,mute:1,playsinline:a,autoplay:1},callback:function(){e(window).trigger("resize")}})})},unload:function(t){var o=e(".slideshow-"+t.detail.sectionId);o.find(".slideshow-carousel").flickity("destroy");var a=o.find(".slide__item-video .slide__item-image");a.removeData("yt-init").removeData("ytPlayer").removeClass("loaded"),e(window).off("resize.YTplayer"+a.ID),e(window).off("scroll.YTplayer"+a.ID),a.$body=null,a.$node=null,a.$YTPlayerString=null,a.player=null},blockSelect:function(t){var o=e("#block-"+t.detail.blockId),a=o.closest(".slideshow-carousel"),r=o.data("slide-index");a.flickity("pausePlayer"),a.flickity("select",r,!0,!0),a.find("img").removeClass(".lazymanual").addClass("lazyload")},blockDeselect:function(t){e("#block-"+t.detail.blockId).closest(".slideshow-carousel").flickity("unpausePlayer")}}}(),StyleHatch.HeroVideoSection=function(){return function(t){var o=this.$container=e(t);o.attr("data-section-id"),StyleHatch.HeroVideo.init(o)}}(),StyleHatch.HeroVideoSection.prototype=e.extend({},StyleHatch.HeroVideoSection.prototype,{onUnload:function(e){StyleHatch.HeroVideo.unload(e)}}),StyleHatch.HeroVideo=function(){return{init:function(e){var t=e.find(".wrapper"),o=e.data("video-id"),a=0;e.data("mobile-autoplay")&&(a=1),t.removeData("ytPlayer"),t.YTPlayer({fitToBackground:!1,videoId:o,repeat:!0,mute:!0,playerVars:{rel:0,mute:1,playsinline:a,autoplay:1}})},unload:function(t){var o=e(".slideshow-"+t.detail.sectionId).find(".wrapper");o.removeData("yt-init").removeData("ytPlayer").removeClass("loaded"),o.find(".ytplayer-container .ytplayer-shield").remove()}}}(),StyleHatch.Maps=function(){function t(t){this.$container=e(t),this.$map=this.$container.find(d.map),this.key=this.$map.data("api-key"),this.key!=n&&(n=this.key,r=null,i=!0),void 0!==this.key&&("loaded"===r?this.createMap():(s.push(this),"loading"!==r&&(r="loading",(void 0===window.google||i)&&e.getScript("https://maps.googleapis.com/maps/api/js?key="+this.key).then(function(){r="loaded",i=!1,e.each(s,function(e,t){t.createMap()})}))))}function o(t){var o=e.Deferred(),a=new google.maps.Geocoder,r=t.data("address-setting");return a.geocode({address:r},function(e,t){t!==google.maps.GeocoderStatus.OK&&o.reject(t),o.resolve(e)}),o}var a=14,r=null,n=null,i=!1,s=[],l={standard:[],silver:[{elementType:"geometry",stylers:[{color:"#f5f5f5"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f5f5"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#ffffff"}]},{featureType:"road.arterial",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#dadada"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#c9c9c9"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]}],retro:[{elementType:"geometry",stylers:[{color:"#ebe3cd"}]},{elementType:"labels.text.fill",stylers:[{color:"#523735"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f1e6"}]},{featureType:"administrative",elementType:"geometry.stroke",stylers:[{color:"#c9b2a6"}]},{featureType:"administrative.land_parcel",elementType:"geometry.stroke",stylers:[{color:"#dcd2be"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#ae9e90"}]},{featureType:"landscape.natural",elementType:"geometry",stylers:[{color:"#dfd2ae"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#dfd2ae"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#93817c"}]},{featureType:"poi.park",elementType:"geometry.fill",stylers:[{color:"#a5b076"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#447530"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#f5f1e6"}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#fdfcf8"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#f8c967"}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#e9bc62"}]},{featureType:"road.highway.controlled_access",elementType:"geometry",stylers:[{color:"#e98d58"}]},{featureType:"road.highway.controlled_access",elementType:"geometry.stroke",stylers:[{color:"#db8555"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#806b63"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#dfd2ae"}]},{featureType:"transit.line",elementType:"labels.text.fill",stylers:[{color:"#8f7d77"}]},{featureType:"transit.line",elementType:"labels.text.stroke",stylers:[{color:"#ebe3cd"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#dfd2ae"}]},{featureType:"water",elementType:"geometry.fill",stylers:[{color:"#b9d3c2"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#92998d"}]}],dark:[{elementType:"geometry",stylers:[{color:"#212121"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{elementType:"labels.text.stroke",stylers:[{color:"#212121"}]},{featureType:"administrative",elementType:"geometry",stylers:[{color:"#757575"}]},{featureType:"administrative.country",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"administrative.land_parcel",stylers:[{visibility:"off"}]},{featureType:"administrative.locality",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#181818"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"poi.park",elementType:"labels.text.stroke",stylers:[{color:"#1b1b1b"}]},{featureType:"road",elementType:"geometry.fill",stylers:[{color:"#2c2c2c"}]},{featureType:"road",elementType:"labels.text.fill",stylers:[{color:"#8a8a8a"}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#373737"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#3c3c3c"}]},{featureType:"road.highway.controlled_access",elementType:"geometry",stylers:[{color:"#4e4e4e"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"transit",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#000000"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#3d3d3d"}]}],night:[{elementType:"geometry",stylers:[{color:"#242f3e"}]},{elementType:"labels.text.fill",stylers:[{color:"#746855"}]},{elementType:"labels.text.stroke",stylers:[{color:"#242f3e"}]},{featureType:"administrative.locality",elementType:"labels.text.fill",stylers:[{color:"#d59563"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#d59563"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#263c3f"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#6b9a76"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#38414e"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{color:"#212a37"}]},{featureType:"road",elementType:"labels.text.fill",stylers:[{color:"#9ca5b3"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#746855"}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#1f2835"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#f3d19c"}]},{featureType:"transit",elementType:"geometry",stylers:[{color:"#2f3948"}]},{featureType:"transit.station",elementType:"labels.text.fill",stylers:[{color:"#d59563"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#17263c"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#515c6d"}]},{featureType:"water",elementType:"labels.text.stroke",stylers:[{color:"#17263c"}]}],aubergine:[{elementType:"geometry",stylers:[{color:"#1d2c4d"}]},{elementType:"labels.text.fill",stylers:[{color:"#8ec3b9"}]},{elementType:"labels.text.stroke",stylers:[{color:"#1a3646"}]},{featureType:"administrative.country",elementType:"geometry.stroke",stylers:[{color:"#4b6878"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#64779e"}]},{featureType:"administrative.province",elementType:"geometry.stroke",stylers:[{color:"#4b6878"}]},{featureType:"landscape.man_made",elementType:"geometry.stroke",stylers:[{color:"#334e87"}]},{featureType:"landscape.natural",elementType:"geometry",stylers:[{color:"#023e58"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#283d6a"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#6f9ba5"}]},{featureType:"poi",elementType:"labels.text.stroke",stylers:[{color:"#1d2c4d"}]},{featureType:"poi.park",elementType:"geometry.fill",stylers:[{color:"#023e58"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#3C7680"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#304a7d"}]},{featureType:"road",elementType:"labels.text.fill",stylers:[{color:"#98a5be"}]},{featureType:"road",elementType:"labels.text.stroke",stylers:[{color:"#1d2c4d"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#2c6675"}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#255763"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#b0d5ce"}]},{featureType:"road.highway",elementType:"labels.text.stroke",stylers:[{color:"#023e58"}]},{featureType:"transit",elementType:"labels.text.fill",stylers:[{color:"#98a5be"}]},{featureType:"transit",elementType:"labels.text.stroke",stylers:[{color:"#1d2c4d"}]},{featureType:"transit.line",elementType:"geometry.fill",stylers:[{color:"#283d6a"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#3a4762"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#0e1626"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#4e6d70"}]}]},c={addressNoResults:StyleHatch.Strings.addressNoResults,addressQueryLimit:StyleHatch.Strings.addressQueryLimit,addressError:StyleHatch.Strings.addressError,authError:StyleHatch.Strings.authError},d={section:'[data-section-type="maps"]',map:"[data-map]",mapOverlay:"[data-map-overlay]"},u="map-selection--load-error",p="map-section__errors errors text-center";return window.gm_authFailure=function(){return Shopify.designMode?(e(d.section).addClass(u),e(d.map).remove(),void e(d.mapOverlay).after('<div class="'+p+'">'+StyleHatch.Strings.authError+"</div>")):void log("Google Maps authentication error",window.google,r)},t.prototype=e.extend({},t.prototype,{createMap:function(){var e=this.$map,t=e.data("map-style");return o(e).then(function(o){var r={zoom:a,center:o[0].geometry.location,draggable:!1,clickableIcons:!1,scrollwheel:!1,disableDoubleClickZoom:!0,disableDefaultUI:!0,styles:l[t]},n=this.map=new google.maps.Map(e[0],r),i=this.center=n.getCenter();new google.maps.Marker({map:n,position:n.getCenter()}),google.maps.event.addDomListener(window,"resize",slate.utils.debounce(function(){google.maps.event.trigger(n,"resize"),n.setCenter(i),e.removeAttr("style")},250))}.bind(this)).fail(function(){var t;switch(status){case"ZERO_RESULTS":t=c.addressNoResults;break;case"OVER_QUERY_LIMIT":t=c.addresQueryLimit;break;case"REQUEST_DENIED":t=c.authError;break;default:t=c.addressError}Shopify.designMode&&e.parent().addClass(u).append('<div class="'+p+'">'+t+"</div>")})},onUnload:function(){0!==this.$map.length&&google.maps.event.clearListeners(this.map,"resize")}}),t}(),StyleHatch.PageSection=function(){return function(t){var o=this.$container=e(t);o.attr("data-section-id"),StyleHatch.Page.init(o)}}(),StyleHatch.Page=function(){return{init:function(e){e.fitVids()},unload:function(e){}}}(),StyleHatch.FeaturedCollectionSection=function(){return function(t){var o=this.$container=e(t);o.attr("data-section-id"),o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}}(),StyleHatch.FeaturedCollectionSection.prototype=e.extend({},StyleHatch.FeaturedCollectionSection.prototype,{onUnload:function(t){var o=e("#section-"+t.detail.sectionId);o.attr("data-section-id"),o.destroyProductBox()}}),StyleHatch.SimpleCollectionSection=function(){return function(t){var o=this.$container=e(t);o.attr("data-section-id"),o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}}(),StyleHatch.SimpleCollectionSection.prototype=e.extend({},StyleHatch.SimpleCollectionSection.prototype,{onUnload:function(t){var o=e("#section-"+t.detail.sectionId);o.attr("data-section-id"),o.destroyProductBox()}}),StyleHatch.instagrams={},StyleHatch.InstagramSection=function(){return function(t){var o=this.$container=e(t),a=o.attr("data-section-id"),r=this.instagram="#Instagram-"+a;if(e("html").hasClass("lt-ie9"))return!1;var n=o.find(".instagram-container"),i=o.find("header a.button, footer a.button"),s=o.data("image-count"),l=o.data("instagram-access-token"),c="https://api.instagram.com/v1/users/self/media/recent/?access_token="+l+"&count=20",d=StyleHatch.Strings.instagramAddToken,u=StyleHatch.Strings.instagramInvalidToken,p=StyleHatch.Strings.instagramRateLimitToken,h=function(t){if(t.data){if(t.data.length<s){var a=t.data.length,r=s-(s-a);s=t.data.length,o.find(".box").each(function(t){t>=r&&e(this).hide()})}for(var l=0;l<s;l++){var c=t.data[l].images,d=c.thumbnail.url,u=c.thumbnail.width,p=c.low_resolution.url,h=c.low_resolution.width,f=c.standard_resolution.url,y=c.standard_resolution.width,m=t.data[l].link,g=t.data[l].likes.count,v=t.data[l].comments.count,b="";t.data[l].caption&&(b=t.data[l].caption.text);var S=o.find(".box-"+l),w=S.find("figure > a"),T=S.find("figure > a, li > a"),C=S.find("figcaption > p"),x=S.find("a.likes span.label"),H=S.find("a.comments span.label");w.html('<div class="card__image lazyload">');var $=w.find(".card__image");$.attr("data-sizes","auto"),$.attr("data-bgset",d+" "+u+"w, "+p+" "+h+"w, "+f+" "+y+"w"),T.attr("href",m),C.html(b),x.text(g),H.text(v)}var k="https://www.instagram.com/"+t.data[0].user.username;i.attr("href",k),i.attr("target","_blank"),o.show(),n.addClass("loaded")}};if(storeWithExpiration.get(l)&&!Shopify.designMode){var f=storeWithExpiration.get(l);h(f)}else l?e.ajax({url:c,dataType:"jsonp",timeout:5e3,success:function(e){switch(e.meta.code){case 400:Shopify.designMode&&(n.attr("data-helper-text",u),storeWithExpiration.set(l,e,432e5),o.show());break;case 429:Shopify.designMode&&(n.attr("data-helper-text",p),o.show());break;default:h(e),storeWithExpiration.set(l,e,432e5)}}}):Shopify.designMode&&(n.attr("data-helper-text",d),o.show());StyleHatch.instagrams[r]=this}}(),StyleHatch.InstagramSection.prototype=e.extend({},StyleHatch.InstagramSection.prototype,{onUnload:function(){delete StyleHatch.instagrams[this.instagram]}}),StyleHatch.GenericSection=function(){return function(t){(this.$container=e(t)).attr("data-section-id"),StyleHatch.cacheSelectors()}}(),StyleHatch.Product=function(){function t(t){var o=this.$container=e(t),a=o.attr("data-section-id");if(this.settings={enableHistoryState:o.data("enable-history-state")||!1,imageSize:"394x",imageZoomSize:null,namespace:".slideshow-"+a,sectionId:a,zoomEnabled:!1,lightboxEnabled:!1,productImageLightboxData:[]},this.selectors={addToCart:"#AddToCart-"+a,addToCartText:"#AddToCartText-"+a,comparePrice:"#ComparePrice-"+a,originalPrice:"#ProductPrice-"+a,SKU:".variant-sku",originalSelectorId:"#ProductSelect-"+a,productFeaturedImage:"#FeaturedImage-"+a,productImageWrap:".featured-container-"+a,productPrices:".product-single__price-"+a,productThumbImages:".product-single__thumbnail--"+a,productPhoto:"#ProductPhoto-"+a,productImage:"#ProductImage-"+a,productThumbs:"#ProductThumbs-"+a,quantityWrap:".quantity-"+a,quantity:".quantity-select-"+a,cartError:".cart-error-"+a,singleOptionSelector:".single-option-selector-"+a,cartButtons:"#CartButtons-"+a,paymentButtonContainer:"#PaymentButtonContainer-"+a},e("#ProductJson-"+a).html()){this.productSingleObject=JSON.parse(document.getElementById("ProductJson-"+a).innerHTML),this.settings.zoomEnabled=e(this.selectors.productImageWrap).hasClass("featured-zoom"),this.settings.lightboxEnabled=e(this.selectors.productImageWrap).data("lightbox"),o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init(),this._initVariants(),this._initQuanitySelect(),this._initImageSwitch();var r=this;setTimeout(function(){theme.Images.preload(r.productSingleObject.images,r.settings.imageSize)},3e3)}}function o(e){e.easyZoom()}function a(e){e.easyZoom().data("easyZoom").teardown()}return t.prototype=e.extend({},t.prototype,{_initVariants:function(){var e={$container:this.$container,enableHistoryState:this.$container.data("enable-history-state")||!1,singleOptionSelector:this.selectors.singleOptionSelector,originalSelectorId:this.selectors.originalSelectorId,product:this.productSingleObject};this.variants=new slate.Variants(e),this.$container.on("variantChange"+this.settings.namespace,this._updateAddToCart.bind(this)),this.$container.on("variantImageChange"+this.settings.namespace,this._updateImages.bind(this)),this.$container.on("variantPriceChange"+this.settings.namespace,this._updatePrice.bind(this)),this.$container.on("variantSKUChange"+this.settings.namespace,this._updateSKU.bind(this))},_initQuanitySelect:function(){e(this.selectors.quantity).each(function(){var t=e(this),o=t.find(".adjust-minus"),a=t.find(".adjust-plus"),r=t.find("input.quantity"),n=r.val();o.on("click",function(e){(n=r.val())>1&&(n--,r.val(n)),e.preventDefault()}),a.on("click",function(e){n=r.val(),n++,r.val(n),e.preventDefault()})})},_initImageSwitch:function(){if(!Modernizr.touchevents&&this.settings.zoomEnabled&&o(e(this.selectors.productImageWrap)),this.settings.lightboxEnabled){var t=this.productSingleObject.images;StyleHatch.productImageLightboxData=this.settings.productImageLightboxData,StyleHatch.$productPhoto=e(this.selectors.productPhoto),e(window).on("resize",function(){var o=slate.utils.defaultTo(window.devicePixelRatio,1),a=e(window).width(),r=Math.floor(o*a);StyleHatch.productImageLightboxData=[];for(var n=0;n<t.length;n++){var i=t[n],s={src:theme.Images.getSizedImageUrl(i,r+"x")};StyleHatch.productImageLightboxData.push(s)}}).trigger("resize");var a=e(this.selectors.productImageWrap);e(this.selectors.productImageWrap).find("a").magnificPopup({type:"image",mainClass:"mfp-with-zoom",items:StyleHatch.productImageLightboxData,gallery:{enabled:!0},callbacks:{beforeOpen:function(e){var t=parseInt(a.find("img").attr("data-position"));this.goTo(t)}}})}if(e(this.selectors.productThumbImages).length){var r=this;e(this.selectors.productThumbImages).on("click",function(t){t.preventDefault();var o=e(this);o.find("img").data("img"),o.find("img").data("highres"),r._updateResponsiveImage(o)})}let n=0,i=0,s=0,l=0;const c=document.getElementsByClassName("productimage-limit")[0];c.addEventListener("touchstart",function(e){n=e.changedTouches[0].screenX,i=e.changedTouches[0].screenY},!1),c.addEventListener("touchend",function(e){s=e.changedTouches[0].screenX,l=e.changedTouches[0].screenY,function(){if(s<n){var e=parseInt(c.getElementsByTagName("img")[0].getAttribute("data-position"))+1,t=document.body.querySelector('[data-position="'+e+'"]'),o=document.body.querySelectorAll("[data-position]").length-1;if(o>3)var a=parseInt(o/2-1);else var a=o;e>=a&&(t=a>4?document.body.querySelectorAll("[data-position]")[4]:document.body.querySelectorAll('[data-position="0"]')[0])}if(s>n){var e=parseInt(c.getElementsByTagName("img")[0].getAttribute("data-position"))-1,t=document.body.querySelector('[data-position="'+e+'"]');e<0&&(t=(t=document.body.querySelectorAll("[data-position]"))[t.length-1])}t.click()}()},!1)},_updateResponsiveImage:function(t){var r=t,n=r.find("img"),i=e(this.selectors.productImage),s=i.closest(".card__image-container"),l=i.closest(".featured-container"),c=i.closest(".productimage-limit");i.attr({src:n.data("default"),alt:n.attr("alt"),srcset:"","data-src":n.data("src-pattern"),"data-aspectratio":n.data("aspectratio"),"data-position":n.data("position"),"data-max-width":n.data("max-width"),"data-widths":"["+n.data("widths")+"]","data-id":i.data("id"),"data-sizes":i.data("sizes")}),c.css({"max-width":n.data("max-width")+"px"}),this.settings.zoomEnabled&&a(l),s.attr("href",r.attr("href")),!Modernizr.touchevents&&this.settings.zoomEnabled&&(s.data("zoom",r.attr("href")),o(l));var d="active";e(this.selectors.productThumbImages).removeClass(d),r.addClass(d)},_updateAddToCart:function(t){var o=t.variant;o?(e(this.selectors.cartError).hide(),e(this.selectors.productPrices).removeClass("visibility-hidden").attr("aria-hidden","true"),o.available?(e(this.selectors.addToCart).removeClass("disabled").prop("disabled",!1),e(this.selectors.addToCartText).text(StyleHatch.Strings.addToCart),e(this.selectors.quantityWrap).show(),e(this.selectors.cartButtons).addClass("cart-buttons__enabled")):(e(this.selectors.addToCart).addClass("disabled").prop("disabled",!0),e(this.selectors.addToCartText).text(StyleHatch.Strings.soldOut),e(this.selectors.quantityWrap).hide(),e(this.selectors.cartButtons).removeClass("cart-buttons__enabled"))):(e(this.selectors.addToCart).addClass("disabled").prop("disabled",!0),e(this.selectors.addToCartText).text(StyleHatch.Strings.soldOut),e(this.selectors.productPrices).addClass("visibility-hidden").attr("aria-hidden","false"),e(this.selectors.quantityWrap).hide(),e(this.selectors.cartButtons).removeClass("cart-buttons__enabled"))},_updateImages:function(t){var o=t.variant;theme.Images.getSizedImageUrl(o.featured_image.src,this.settings.imageSize),this.settings.zoomEnabled&&theme.Images.getSizedImageUrl(o.featured_image.src,this.settings.imageZoomSize);var a=e(this.selectors.productThumbImages+'[data-image-id="'+o.featured_image.id+'"]');this._updateResponsiveImage(a)},_updatePrice:function(t){var o=t.variant;e(this.selectors.originalPrice).html(theme.Currency.formatMoney(o.price,StyleHatch.currencyFormat)),StyleHatch.currencyConverter&&(removeDataAttributes(e(this.selectors.originalPrice)),Currency.convertAll(StyleHatch.shopCurrency,e("[name=currencies]").val()),e(".selected-currency").text(Currency.currentCurrency)),o.compare_at_price>o.price?(e(this.selectors.comparePrice).find("span.money").html(theme.Currency.formatMoney(o.compare_at_price,StyleHatch.currencyFormat)),e(this.selectors.comparePrice).show()):e(this.selectors.comparePrice).hide()},_updateSKU:function(t){var o=t.variant;e(this.selectors.SKU).html(o.sku)},onUnload:function(){this.$container.off(this.settings.namespace),e.magnificPopup.close(),this.settings.zoomEnabled&&a(e(this.selectors.productImageWrap)),StyleHatch.ajaxCartEnable&&StyleHatch.AjaxCart.unload(),this.$container.destroyProductBox()}}),t}(),StyleHatch.Collection=function(){function t(t){var o=this.$container=e(t);o.attr("data-section-id"),this.$sortSelect=e(r.sortSelection,o),this.defaultSort=this._getDefaultSortValue(),this.$viewButton=e(r.viewChange),this.$sortSelect.on("change",this._onSortChange.bind(this)),this.$viewButton.on("click",this._onViewChange),this.$productbox=e(r.productBox,o),this._initSidebar(),this._initAdvancedTags(),o.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}var o="sort_by",a="title-ascending",r={sortSelection:"#SortBy",defaultSort:".sort-by__default-sort",viewChange:".change-view",advancedFilter:".advanced-filter a",filterCollection:".mobile-aside-container > a.button.simple",mobileAside:".mobile-aside-container aside",productBox:".box.product .image-table",nestedMenu:"ul.nested-menu"};return t.prototype=e.extend({},t.prototype,{_onSortChange:function(e){var t="";this.sort=this._getSortValue(),this.sort!==this.defaultSort&&(t=[o+"="+this.sort]);var a=document.URL;if(a.indexOf("?")>-1)document.location.href=replaceUrlParam(a,o,this.sort);else{var r=document.location.search=t.length?"?"+t:"";document.location.href=this.$filterSelect.val()+r}},_getSortValue:function(){return this.$sortSelect.val()||this.defaultSort},_getDefaultSortValue:function(){return e(r.defaultSort,this.$container).val()||a},_onViewChange:function(t){var o=e(this).data("view"),a=document.URL,r=a.indexOf("?")>-1;window.location=r?replaceUrlParam(a,"view",o):a+"?view="+o,t.preventDefault()},_initSidebar:function(){e(r.filterCollection).on("click",function(t){e(r.mobileAside).slideToggle(),t.preventDefault()}),this.$container.find(r.nestedMenu).initNestedMenu()},_initAdvancedTags:function(){var t,o,a,n;e(r.advancedFilter).on("click",function(r){t=e(this).parent(),o=t.data("group"),a=t.data("handle"),n=e('.active[data-group="'+o+'"]'),!t.hasClass("active")&&n.length&&(r.preventDefault(),location.href=location.href.replace(n.data("handle"),a).replace(/(&page=\d+)|(page=\d+&)|(\?page=\d+$)/,""))})},onUnload:function(){this.$sortSelect.off("change"),this.$viewButton.off("click"),e(r.advancedFilter).off("click"),this.$container.destroyProductBox(),this.$container.find(r.nestedMenu).destroyNestedMenu()}}),t}(),StyleHatch.ListCollections=function(){function t(t){var a=this.$container=e(t),r=(a.attr("data-section-id"),a.data("layout"));a.find(".card__image"),this.$productbox=e(o.productBox,a),"preview"==r&&a.productBox(),StyleHatch.currencyConverter&&StyleHatch.CurrencyConverter.init()}var o={productBox:".box .image-table"};return t.prototype=e.extend({},t.prototype,{onUnload:function(){$container.destroyProductBox()}}),t}(),StyleHatch.BlogArticle=function(){function t(t){(this.$container=e(t)).attr("data-section-id"),this._initSidebar(),StyleHatch.videoLayout()}var o=".mobile-aside-container > a.button.simple",a=".mobile-aside-container aside",r="ul.nested-menu";return t.prototype=e.extend({},t.prototype,{_initSidebar:function(){e(o).on("click",function(t){e(a).slideToggle(),t.preventDefault()}),this.$container.find(r).initNestedMenu()},onUnload:function(){e(o).off("click"),this.$container.find(r).destroyNestedMenu()}}),t}(),StyleHatch.Password=function(){function t(t){var o=((this.$container=e(t)).attr("data-section-id"),e("#login_form"));e(".login-popup").magnificPopup({type:"inline",midClick:!0,mainClass:"mfp-fade",closeBtnInside:!1,callbacks:{afterClose:function(){e("a").blur(),o.find(".errors").remove()}}}),e("#mc-embedded-subscribe-form").on("submit",function(){e("p.signup-message").hide(),e("p.thanks-message").show(),e(this).find(".input-row").hide()}),o.find(".errors").length>0&&e(".login-popup").magnificPopup("open")}return t.prototype=e.extend({},t.prototype,{onUnload:function(){e.magnificPopup.close(),e("#mc-embedded-subscribe-form").off("submit")}}),t}(),StyleHatch.Cart=function(){function t(t){(this.$container=e(t)).attr("data-section-id"),StyleHatch.quantitySelect()}return t.prototype=e.extend({},t.prototype,{onUnload:function(){}}),t}(),StyleHatch.AjaxCart=function(){function t(t,o){var a=r.$util,n=r.$cartPreview;clearTimeout(r.hideCartPreview),r.$cartPreview.hide();var i=o.item_count,s=theme.Currency.formatMoney(o.total_price,StyleHatch.currencyFormat),l=(t=JSON.parse(t)).product_title,c=t.variant_options,d=t.image,u=t.url,p=theme.Currency.formatMoney(t.price,StyleHatch.currencyFormat),h=(t.quantity,theme.Currency.formatMoney(t.line_price,StyleHatch.currencyFormat),n.find(".product-image").empty());h.append('<img src="'+d+'" alt="'+l+'">'),h.attr("href",u);var f=n.find(".product-title");f.html(l),f.attr("href",u);var y=n.find(".product-variant").empty();e.each(c,function(){this.toLowerCase().indexOf("default title")<0?(y.show(),y.append("<li>"+this+"</li>")):y.hide()});var m=n.find(".product-price");m.removeClass("money"),m.html('<span class="money">'+p+"</span>"),n.find(".item-count").text(i),i>1?(n.find(".count.plural").show(),n.find(".count.singular").hide()):(n.find(".count.plural").hide(),n.find(".count.singular").show()),n.find(".total-price").html('<span class="money">'+s+"</span>");var g=a.height();n.css({top:g}),n.fadeIn(300),r.hideCartPreview=setTimeout(function(){n.fadeOut(300)},6e3),n.find("a.continue-shopping").on("click",function(e){n.fadeOut(300),e.preventDefault()}),StyleHatch.currencyConverter&&Currency.convertAll(StyleHatch.shopCurrency,jQuery("[name=currencies]").val())}var o={body:"body",util:"header.util",cartPreview:"header.util .cart-preview",addToCartForm:"[data-AddToCartForm] > form",addToCartButton:"[data-AddToCartForm]",cartButton:"[data-CartButton]",cartCount:"#CartCount",cartCost:"#CartCost"},a={addURL:"/cart/add.js",cartURL:"/cart.js",clearURL:"/cart/clear.js"},r={};return{init:function(){(r={$body:e(o.body),$util:e(o.util),$cartPreview:e(o.cartPreview),$addToCartForm:e(o.addToCartForm),$addToCartButton:e(o.addToCartButton),$cartButton:e(o.cartButton),$cartCount:e(o.cartCount),$cartCost:e(o.cartCost)}).$addToCartForm.each(function(){e(this).on("submit",function(o){var n=e(this);(function(o){var n=(o=o).find(".cart-error"),i=o.find("[data-AddToCartText]").html(),s=(o.find("[data-AddToCartText]").attr("data-added"),o.find("[data-AddToCartText]").attr("data-adding"));o.find("[data-AddToCart]").addClass("added").prop("disabled",!0),o.find("[data-AddToCartText]").html(s),n.hide(),e.post(a.addURL,o.serialize(),function(n){var s=n;e.get(a.cartURL,function(e){var a=e;(function(e){var t=(r.$cartButton,r.$cartCount),o=r.$cartCost,a=e.item_count,n=theme.Currency.formatMoney(e.total_price,StyleHatch.currencyFormat);t.text(a),o.removeClass("money"),o.html('<span class="money">'+n+"</span>"),StyleHatch.currencyConverter&&Currency.convertAll(StyleHatch.shopCurrency,jQuery("[name=currencies]").val())})(a),t(s,a),setTimeout(function(){o.find("[data-AddToCart]").removeClass("added").prop("disabled",!1),o.find("[data-AddToCartText]").html(i)},500)},"json")},"text").error(function(e){if(void 0!==e&&void 0!==e.status){var t=JSON.parse(e.responseText);n.html("<strong>"+t.message+":</strong> <em>"+t.description+"<em>"),n.slideDown()}setTimeout(function(){o.find("[data-AddToCart]").removeClass("added").prop("disabled",!1),o.find("[data-AddToCartText]").html(i)},500)})})(n),o.preventDefault()})})},clearCart:function(){e.post(a.clearURL)},unload:function(){r.$addToCartForm.off("submit"),clearTimeout(r.hideCartPreview),r.$cartPreview.hide()}}}(),StyleHatch.CurrencyConverter=function(){function t(){a.cookieCurrency=Currency.cookie.read(),e("span.money span.money").each(function(){e(this).parents(o.money).removeClass("money")}),r.$money.each(function(){""!==Currency.currentCurrency?e(this).attr("data-currency-"+Currency.currentCurrency,e(this).html()):e(this).attr("data-currency-"+StyleHatch.shopCurrency,e(this).html())}),null==a.cookieCurrency?StyleHatch.shopCurrency!==StyleHatch.defaultCurrency?Currency.convertAll(StyleHatch.shopCurrency,StyleHatch.defaultCurrency):Currency.currentCurrency=StyleHatch.defaultCurrency:e("[name=currencies]").length&&0===e("[name=currencies] option[value="+a.cookieCurrency+"]").length?(Currency.currentCurrency=StyleHatch.shopCurrency,Currency.cookie.write(StyleHatch.shopCurrency)):a.cookieCurrency===StyleHatch.shopCurrency?Currency.currentCurrency=StyleHatch.shopCurrency:Currency.convertAll(StyleHatch.shopCurrency,a.cookieCurrency),e("[name=currencies]").val(Currency.currentCurrency).change(function(){var t=e(this).val();Currency.convertAll(Currency.currentCurrency,t),e(".selected-currency").text(Currency.currentCurrency),e("p.currency-at-checkout").length>0&&(Currency.currentCurrency==StyleHatch.shopCurrency?e("p.currency-at-checkout").hide():e("p.currency-at-checkout").show())}),e("[name=currencies]").val(Currency.currentCurrency).change()}var o={body:"body",money:"span.money"},a={enabled:!1},r={};return{init:function(){r={$body:e(o.body),$money:e(o.money)},t()},config:a,convert:t}}(),window.theme=window.theme||{},window.slate=window.slate||{},theme.Images=function(){return{preload:function(e,t){"string"==typeof e&&(e=[e]);for(var o=0;o<e.length;o++){var a=e[o];this.loadImage(this.getSizedImageUrl(a,t))}},loadImage:function(e){(new Image).src=e},switchImage:function(e,t,o){var a=this.imageSize(t.src),r=this.getSizedImageUrl(e.src,a);o?o(r,e,t):t.src=r},imageSize:function(e){var t=e.match(/.+_((?:pico|icon|thumb|small|compact|medium|large|grande)|\d{1,4}x\d{0,4}|x\d{1,4})[_\.@]/);return null!==t?t[1]:null},getSizedImageUrl:function(e,t){if(null==t)return e;if("master"===t)return this.removeProtocol(e);var o=e.match(/\.(jpg|jpeg|gif|png|bmp|bitmap|tiff|tif)(\?v=\d+)?$/i);if(null!=o){var a=e.split(o[0]),r=o[0];return this.removeProtocol(a[0]+"_"+t+r)}return null},removeProtocol:function(e){return e.replace(/http(s)?:/,"")}}}(),theme.Currency=function(){var e="${{amount}}";return{formatMoney:function(t,o){function a(e,t,o,a){if(t=slate.utils.defaultTo(t,2),o=slate.utils.defaultTo(o,","),a=slate.utils.defaultTo(a,"."),isNaN(e)||null==e)return 0;var r=(e=(e/100).toFixed(t)).split(".");return r[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1"+o)+(r[1]?a+r[1]:"")}"string"==typeof t&&(t=t.replace(".",""));var r="",n=/\{\{\s*(\w+)\s*\}\}/,i=o||e;switch(i.match(n)[1]){case"amount":r=a(t,2);break;case"amount_no_decimals":r=a(t,0);break;case"amount_with_comma_separator":r=a(t,2,".",",");break;case"amount_no_decimals_with_comma_separator":r=a(t,0,".",",");break;case"amount_no_decimals_with_space_separator":r=a(t,0," ")}return i.replace(n,r)}}}(),slate.utils={findInstance:function(e,t,o){for(var a=0;a<e.length;a++)if(e[a][t]===o)return e[a]},removeInstance:function(e,t,o){for(var a=e.length;a--;)if(e[a][t]===o){e.splice(a,1);break}return e},compact:function(e){for(var t=-1,o=null==e?0:e.length,a=0,r=[];++t<o;){var n=e[t];n&&(r[a++]=n)}return r},defaultTo:function(e,t){return null==e||e!=e?t:e},debounce:function(e,t,o){var a;return function(){var r=this,n=arguments,i=o&&!a;clearTimeout(a),a=setTimeout(function(){a=null,o||e.apply(r,n)},t),i&&e.apply(r,n)}}},slate.Variants=function(){function t(t){this.$container=t.$container,this.product=t.product,this.singleOptionSelector=t.singleOptionSelector,this.originalSelectorId=t.originalSelectorId,this.enableHistoryState=t.enableHistoryState,this.currentVariant=this._getVariantFromOptions(),e(this.singleOptionSelector,this.$container).on("change",this._onSelectChange.bind(this))}return t.prototype=e.extend({},t.prototype,{_getCurrentOptions:function(){var t=e.map(e(this.singleOptionSelector,this.$container),function(t){var o=e(t),a=o.attr("type"),r={};return"radio"===a||"checkbox"===a?!!o[0].checked&&(r.value=o.val(),r.index=o.data("index"),r):(r.value=o.val(),r.index=o.data("index"),r)});return slate.utils.compact(t)},_getVariantFromOptions:function(){var e=this._getCurrentOptions(),t=this.product.variants,o=!1;return t.forEach(function(t){var a=!0;t.options,e.forEach(function(e){a&&(a=e.value===t[e.index])}),a&&(o=t)}),o||null},_onSelectChange:function(){var e=this._getVariantFromOptions();this.$container.trigger({type:"variantChange",variant:e}),e&&(this._updateMasterSelect(e),this._updateImages(e),this._updatePrice(e),this._updateSKU(e),this.currentVariant=e,this.enableHistoryState&&this._updateHistoryState(e))},_updateImages:function(e){var t=e.featured_image||{},o=this.currentVariant.featured_image||{};e.featured_image&&t.src!==o.src&&this.$container.trigger({type:"variantImageChange",variant:e})},_updatePrice:function(e){e.price===this.currentVariant.price&&e.compare_at_price===this.currentVariant.compare_at_price||this.$container.trigger({type:"variantPriceChange",variant:e})},_updateSKU:function(e){e.sku!==this.currentVariant.sku&&this.$container.trigger({type:"variantSKUChange",variant:e})},_updateHistoryState:function(e){if(history.replaceState&&e){var t=window.location.protocol+"//"+window.location.host+window.location.pathname+"?variant="+e.id;window.history.replaceState({path:t},"",t)}},_updateMasterSelect:function(t){e(this.originalSelectorId,this.$container)[0].value=t.id}}),t}(),e.fn.extend({productBox:function(){var t=e(this).find(".box.product figure");t.on("click",function(t){if(e(t.target).is(".vendor")||e(t.target).parent().is(".vendor"));else{t.preventDefault();var o=e(this).find("a").attr("href");t.shiftKey||t.ctrlKey||t.metaKey?window.open(o,"_blank"):window.location=o}}),Modernizr.objectfit||t.find(".product_card__image-wrapper").each(function(){var t=e(this),o=t.find(".product_card__image.alt");t.find("img").prop("src"),o.hide(),t.addClass("ie-fallback lazyload")})},destroyProductBox:function(){e(this).find(".box.product figure").off("click")},initNestedMenu:function(){var t=e(this).find('a[aria-haspopup="true"]'),o=function(e){var t=e.find("li.has-sub-dropdown.expanded");if(t.length>0){t.removeClass("expanded"),t.find("> a").attr("aria-expanded","false");var a=t.find("> ul.sub-dropdown");a.attr("aria-hidden","true"),a.slideUp(),a.find("a").attr("tabindex","-1"),o(e)}};t.on("click",function(t){var a=e(this),r=a.parent(),n=r.find("> ul"),i=r.find("> ul > li > a"),s=a.closest("ul.nested-menu");"true"!==a.attr("aria-expanded")&&(t.preventDefault(),r.hasClass("has-dropdown")?function(e){var t=e.find("li.has-dropdown.expanded");if(t.length>0){t.removeClass("expanded"),t.find("> a").attr("aria-expanded","false");var a=t.find("> ul.dropdown");a.attr("aria-hidden","true"),a.slideUp(),a.find("a").attr("tabindex","-1"),o(e)}}(s):o(s),a.attr("aria-expanded","true"),r.addClass("expanded"),n.attr("aria-hidden","false"),i.attr("tabindex","0"),n.slideDown())})},destroyNestedMenu:function(){e(this).find('a[aria-haspopup="true"]').off("click")}}),StyleHatch.refreshFixTo=function(){StyleHatch.Promos.refreshFixTo(),e("*").filter(function(){return e(this).data("fixtoInstance")}).each(function(t){e(this).data("fixto-instance")._running&&e(this).fixTo("refresh")})},StyleHatch.videoLayout=function(){e(".rte").fitVids()},StyleHatch.loginForms=function(){function e(){StyleHatch.cache.$recoverPasswordForm.show(),StyleHatch.cache.$customerLoginForm.hide()}StyleHatch.cache.$recoverPasswordLink.on("click",function(t){t.preventDefault(),e(),StyleHatch.updateHash("recover")}),StyleHatch.cache.$hideRecoverPasswordLink.on("click",function(e){e.preventDefault(),StyleHatch.cache.$recoverPasswordForm.hide(),StyleHatch.cache.$customerLoginForm.show(),StyleHatch.updateHash()}),"#recover"==StyleHatch.getHash()&&e()},StyleHatch.initTemplates=function(){switch(StyleHatch.cache.$body.data("template")){case"addresses":StyleHatch.initCustomerAddressTemplate()}},StyleHatch.initCustomerAddressTemplate=function(){StyleHatch.addressJSValidation&&e('.customer-address input[type="submit"]').on("click",function(t){var o=e(this).closest("form"),a=o.find('input[name="address[last_name]"]'),r=o.find('input[name="address[address1]"]'),n=o.find('input[name="address[city]"]'),i=o.find('select[name="address[country]"]'),s=o.find('select[name="address[province]"]'),l=o.find('input[name="address[zip]"]');a.val()||a.addClass("required"),r.val()||r.addClass("required"),n.val()||n.addClass("required"),"---"==i.val()&&i.addClass("required"),s.closest(".input-row").is(":visible")&&(s.val()&&"---"!=s.val()&&""!=s.val()||s.addClass("required")),l.val()||l.addClass("required");var c=o.find("input.required, select.required");c.on("focus",function(){e(this).removeClass("required")}),c.length>0?(o.find("div.errors").parent().show(),t.preventDefault()):o.find("div.errors").parent().hide()})},StyleHatch.updateHash=function(t){t?(window.location.hash="#"+t,e("#"+t).attr("tabindex",-1).focus()):window.location.hash=""},StyleHatch.getHash=function(){return window.location.hash},StyleHatch.quantitySelect=function(){e(".quantity-select").each(function(){var t=e(this),o=t.find(".adjust-minus"),a=t.find(".adjust-plus"),r=t.find("input.quantity"),n=r.val();o.on("click",function(e){(n=r.val())>1&&(n--,r.val(n)),e.preventDefault()}),a.on("click",function(e){n=r.val(),n++,r.val(n),e.preventDefault()})})},StyleHatch.resetPasswordSuccess=function(){StyleHatch.cache.$passwordResetSuccess.show()},e(document).ready(function(){StyleHatch.init()})}(jq223);